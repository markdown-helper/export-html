  ...
  try {
    addStyle(
      ...
      .mhe-slides .mhe-slide.two-col {
        ...
        direction: ltr; /* ensure left-to-right column order */
        writing-mode: horizontal-tb; /* prevent vertical writing modes affecting column order */
        height: var(--mhe-slide-max-h, auto); /* JS sets this to available viewport px to avoid page scroll */
      }
      .mhe-slides .mhe-slide.two-col h1,
      .mhe-slides .mhe-slide.two-col h2,
      .mhe-slides .mhe-slide.two-col h3,
      .mhe-slides .mhe-slide.two-col h4,
      .mhe-slides .mhe-slide.two-col h5,
      .mhe-slides .mhe-slide.two-col h6,
      .mhe-slides .mhe-slide.two-col pre,
      .mhe-slides .mhe-slide.two-col table,
      .mhe-slides .mhe-slide.two-col blockquote,
      .mhe-slides .mhe-slide.two-col .mermaid,
      .mhe-slides .mhe-slide.two-col figure,
      .mhe-slides .mhe-slide.two-col img,
      .mhe-slides .mhe-slide.two-col ul,
      .mhe-slides .mhe-slide.two-col ol {
...
export function initSlideDeck(root) {
  ...
  const evaluateActiveTwoCol = () => {
    ...
    if (!wideEnough) { s.classList.remove('two-col'); return; }
    ...
    const needsTwo = contentHeight > available + 8;
    if (needsTwo) {
